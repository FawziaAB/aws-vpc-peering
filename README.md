...
➡️ Le trafic transite bien par le réseau privé AWS, sans passer par Internet.
...
- Diagnostic réseau méthodique (couche par couche : réseau → routage → pare-feu)
- Coordination technique en binôme sur des ressources cloud partagées

---

📄 Le rapport complet est disponible dans ce dépôt : [`Rapport_TP_VPC_Peering_Fawzia.pdf`](./Rapport_TP_VPC_Peering_Fawzia.pdf)

📫 **Contact :** [LinkedIn](https://www.linkedin.com/in/fawzia-aboubakar) · aboubakararike22@gmail.com
